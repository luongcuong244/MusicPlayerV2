...
open class WheelView @JvmOverloads constructor(
    ...
    private fun initAttrsAndDefault(context: Context, attrs: AttributeSet?) {
        ...
        selectedItemTypeface = ResourcesCompat.getFont(context, ta.getResourceId(R.styleable.WheelView_wv_selectedItemFont, R.font.nunito_bold))
        normalItemTypeface = ResourcesCompat.getFont(context, ta.getResourceId(R.styleable.WheelView_wv_normalItemFont, R.font.nunito_medium))
